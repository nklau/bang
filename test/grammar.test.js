...
const syntaxChecks = [
  ...
  ['bang function that returns addition exp', '{ return x + y }'],
  ['bang function that returns subtraction exp', '{ return x - y }'],
  ['bang function that returns multiplication exp', '{ return x * y }'],
